                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" value="" data-inputmask="'alias': 'date'" required id="example-date-input" name="fromdate" min="2022-11-22" >
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">End Date</label>
                                            <input class="form-control" type="date" value="" data-inputmask="'alias': 'date'" required id="example-date-input" name="todate" min="2022-11-22" >
                                        </div>
