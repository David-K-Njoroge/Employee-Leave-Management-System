                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="dob" id="birthdate" autocomplete="off" readonly required value="<?php echo htmlentities($result->Dob);?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="country" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->Country);?>" required id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Address</label>
                                            <input class="form-control" name="address" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->Address);?>" autocomplete="off" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">City</label>
                                            <input class="form-control" name="city" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->City);?>" autocomplete="off" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-form-label">Selected Department</label>
                                            <input class="form-control" name="department" autocomplete="off" readonly required value="<?php echo htmlentities($result->Department);?>">
